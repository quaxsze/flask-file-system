...
class Config(dict):
    """
    Wraps the configuration for a single :class:`Storage`.
...
class Storage:
    ...
    def configure(self, app):
        """
        Loads configuration from application configuration.
    ...
    def open(self, filename, mode='r', **kwargs):
        """
        Opens the file and return a file-like object.
    ...
    def metadata(self, filename):
        """
        Gets some metadata for a given file.
